...
/**
 * The entry class for solving the challenges.
 * 
 * Supports three modes of invocation:
 * - no arguments: runs both challenges
 * - --weather: runs only the weather challenge
 * - --football: runs only the football challenge
 */
